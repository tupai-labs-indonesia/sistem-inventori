...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <?php if ($_SESSION['level'] == 'admin') : ?>
        ...
        <li class="nav-item <?= isset($master) ? 'active' : ''; ?>">
            ...
            <div id="master" class="collapse <?= isset($master) ? 'show' : ''; ?>" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item <?= isset($ukuran) ? 'active' : ''; ?>" href="?ukuran">Ukuran</a>
        ...
        <li class="nav-item <?= isset($catalog) ? 'active' : ''; ?>">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#catalog" aria-expanded="true" aria-controls="catalog">
                <i class="fas fa-fw fa-folder"></i>
                <span>Catalog</span>
            </a>
            <div id="catalog" class="collapse <?= isset($catalog) ? 'show' : ''; ?>" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item <?= isset($Catalog_Ban) ? 'active' : ''; ?>" href="?barang_masuk">Catalog Ban</a>
                    <a class="collapse-item <?= isset($Catalog_Velg) ? 'active' : ''; ?>" href="?barang_keluar">Catalog Velg</a>
                </div>
            </div>
        </li>
    <?php endif; ?>
